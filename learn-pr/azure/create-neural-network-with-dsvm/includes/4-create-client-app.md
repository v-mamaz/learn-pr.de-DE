### <a name="create-a-nothotdog-app"></a><span data-ttu-id="7a34b-101">Erstellen einer NotHotDog-App</span><span class="sxs-lookup"><span data-stu-id="7a34b-101">Create a NotHotDog app</span></span>
