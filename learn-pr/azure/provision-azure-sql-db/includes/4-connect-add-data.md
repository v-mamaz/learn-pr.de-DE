...
Auf Cloud Shell können Sie von überall zugreifen. Außer vom Portal können Sie auch von [shell.azure.com](https://shell.azure.com/), der mobilen Azure-App oder Visual Studio Code aus auf Cloud Shell zugreifen. Der Bereich auf der rechten Seite ist eine Cloud-Shell, die Terminalserver in dieser Übung verwenden.
...
Hier verwenden Sie die `az` Hilfsprogramm zum Auflisten von Ihrer Datenbanken und Anzeigen von Informationen zu den **Logistik** Datenbank, einschließlich der maximalen Größe und den Status.
...
1. Da wir nur die Datenbanknamen benötigen, führen Sie den Befehl ein zweites Mal aus. Reichen Sie die Ausgabe diesmal an `jq` weiter, um nur die Namensfelder auszugeben.
    ...
    ```
    **Logistics** ist Ihre Datenbank. Wie Sie SQL Server, **master** Servermetadaten wie Anmeldekonten und Konfigurationseinstellungen enthält.
