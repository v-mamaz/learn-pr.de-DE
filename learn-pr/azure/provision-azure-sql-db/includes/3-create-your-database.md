...
1. Klicken Sie auf **Tarif**, um die Dienstebene anzugeben. Wählen Sie die Dienstebene **Basic**, und klicken Sie dann auf **Übernehmen**.
...
1. Klicken Sie in der Symbolleiste auf **Benachrichtigungen**, um den Bereitstellungsprozess zu überwachen.
    ![Überwachen des Bereitstellungsprozesses](../media-draft/notifications-progress.png): Wenn der Prozess abgeschlossen ist, klicken Sie auf **An Dashboard anheften**, um Ihren Datenbankserver an das Dashboard anzuheften, sodass Sie später bei Bedarf schnellen Zugriff haben.
...
Im nächsten Teil finden Sie einige praktische Übungen mit der neuen Datenbank und mit Cloud Shell. Sie werden eine Verbindung mit der Datenbank herstellen, eine Tabelle erstellen, einige Beispieldaten hinzufügen und ein paar SQL-Anweisungen ausführen.