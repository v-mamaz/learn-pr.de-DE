Queues hold messages - packets of data whose shape is known to the sender and receiver. The sender creates the queue and adds a message. The receiver retrieves a message, processes it, and then deletes the message from the queue. The following illustration shows a typical flow of this process.
