...
1. Geben Sie auf der jetzt geöffneten Seite **Erstellen** die folgenden Werte in jedes Feld ein.
    ...
    |Standort     |  *Region aus der Dropdownliste auswählen*       |  Wählen Sie aus der folgenden Liste eine Region in Ihrer Nähe aus. |
...
Da wir nun über unseren Schlüssel verfügen, können wir zur Testkonsole wechseln und die API aufrufen.
...
1. Wählen Sie auf dieser Seite eine Region aus, die dem Standort entspricht, der beim Erstellen des Cognitive Services-Kontos zu einem früheren Zeitpunkt in dieser Lektion ausgewählt wurde. Wenn Sie beim Erstellen des Kontos beispielsweise *USA, Westen* ausgewählt haben, dann wählen Sie hier ebenfalls diese Region aus.
    ![Screenshot der Referenzwebsite zur Textanalyse-API mit ausgewähltem Menüelement „Stimmung“ und der Region „USA, Westen“](../media/select-testing-console-region.png) 
