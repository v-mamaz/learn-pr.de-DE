...
1. Öffnen Sie die zuvor erstellte App Service-Ressource (die Web-App). Wenn Sie ihre Ressourcenseite geschlossen haben, können Sie sie erneut öffnen, indem Sie unter **Alle Ressourcen** oder in der enthaltenden Ressourcengruppe unter **Ressourcengruppen** nach der App suchen.
...
1. Sie gelangen wieder zur Seite **Bereitstellungsoption** zurück. Klicken Sie unten auf der Seite auf die Schaltfläche **OK**, um die Bereitstellungsquelle zu erstellen.

1. Navigieren Sie jetzt zum Abschnitt **Bereitstellungscenter (Vorschau)** im linken Navigationsbereich, um die neuen Bereitstellungsdetails anzuzeigen.
...
1. Navigieren Sie zum Inhaltsstammordner der .NET Core-App, die Sie zuvor erstellt haben. Sie können Folgendes eingeben:
...
1. Azure beginnt mit dem Austauschvorgang. Dieser Vorgang dauert in der Regel einige Sekunden, je nach der Größe der ausgetauschten Web-App.
