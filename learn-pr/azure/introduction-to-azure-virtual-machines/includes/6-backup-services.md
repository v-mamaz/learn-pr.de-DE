...
Azure Backup verwendet verschiedene Komponenten, die Sie auf den einzelnen Computern, die Sie sichern möchten, herunterladen bzw. für diese bereitstellen. Die Komponente, die Sie bereitstellen, richtet sich danach, was geschützt werden soll.
