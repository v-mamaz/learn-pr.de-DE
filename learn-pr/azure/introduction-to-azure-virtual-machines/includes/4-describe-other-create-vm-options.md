...
- **Prozessverwaltung**. Angenommen, Sie haben eine VM, die auf ein bestimmtes Fehlerereignis überwacht wird. Sie möchten Maßnahmen ergreifen und das Problem beheben, sobald es gemeldet wird. Mit der Prozessautomatisierung können Sie Watchertasks einrichten, die auf Ereignisse reagieren, die ggf. in Ihrem Datencenter auftreten.
