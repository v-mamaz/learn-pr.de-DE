...
1. Kopieren Sie die **ReplaceFamilyDocument**-Methode, und fügen Sie sie unterhalb der **CreateUserDocumentIfNotExists**-Methode ein.
...
## <a name="delete-documents"></a>Dokumente löschen
