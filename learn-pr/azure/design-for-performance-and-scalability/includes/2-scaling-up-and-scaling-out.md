...
In einer Welt mit einem konstanten Anwendungsbedarf lässt sich der erforderliche Ressourcenbedarf gut vorhersagen. In der realen Welt ändern sich die Anforderungen unserer Anwendungen im Laufe der Zeit, was Vorhersagen zum erforderlichen Bedarf erschweren kann. Wenn Sie Glück haben, sind diese Änderungen vorhersehbar oder saisonal, aber dies trifft nicht auf alle Anwendungen zu. Im Idealfall möchten Sie die richtige Menge an Ressourcen bereitstellen, um die Nachfrage zu erfüllen, und bei Bedarfsänderungen Anpassungen vornehmen.
