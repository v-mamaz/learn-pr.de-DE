...
1. Wählen Sie im Azure-Portal **Daten-Explorer** aus Ihrer Cosmos DB-Ressource aus, und klicken Sie dann auf der Symbolleiste auf die Schaltfläche **Neue Sammlung**.
...
2. Geben Sie auf der Seite **Sammlung hinzufügen** die Einstellungen für die neue Sammlung ein.
    ...
    Aktivieren Sie zu diesem Zeitpunkt noch nicht die Option für den **Durchsatz der Bereitstellungsdatenbank**, und fügen Sie der Sammlung keine eindeutigen Schlüssel hinzu. 
