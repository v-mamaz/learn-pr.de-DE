...
1. Öffnen Sie Ihre Functions-App im [Azure-Portal](https://portal.azure.com/?azure-portal=true).

1. Zeigen Sie im linken Navigationsbereich des Fensters der Functions-App auf **Funktionen**, und klicken Sie auf das Pluszeichen (+), um eine neue serverlose Funktion zu erstellen. Klicken Sie bei der Anzeige einer Schnellstartseite auf **Benutzerdefinierte Funktion**, um eine Liste mit Funktionsvorlagen anzuzeigen.
