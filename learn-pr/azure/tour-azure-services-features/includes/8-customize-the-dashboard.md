...
1. <span data-ttu-id="12cba-159">Klicken Sie auf die Schaltfläche **Bearbeiten**.</span><span class="sxs-lookup"><span data-stu-id="12cba-159">Click the **Edit** button</span></span>
