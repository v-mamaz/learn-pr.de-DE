...
![Eine Abbildung zeigt ein einzelnes Application Gateway, das alle externen Anforderungen an die virtuellen Maschinen an zwei verschiedenen Sites filtert. Die Web Application Firewall-Funktion des Application Gateways schützt das System vor bösartigen Angriffen, während der Lastenausgleich die legitimen Anforderungen auf virtuelle Maschinen verteilt.](../media/appgw-waf.png)
...
![Eine Abbildung zeigt den Azure DDoS-Schutz, der zwischen virtuellem Netzwerk und externen Benutzeranforderungen installiert ist. Der Azure-DDoS-Schutz blockiert bösartige Datenverkehrsangriffe, leitet aber den zulässigen Datenverkehr an das beabsichtigte Ziel weiter.](../media/ddos.png)
...
![Eine Abbildung zeigt die Verwendung der Netzwerksicherheitsgruppe, um die Kommunikation des Back-End und der mittleren Ebene mit dem Internet zu unterbinden. Die Internetanforderungen werden vom Front-End empfangen, das sie dann an die mittlere Ebene weiterleitet. Die mittleren Ebene kommuniziert mit dem Back-End. ](../media/azure-network-security.png)
