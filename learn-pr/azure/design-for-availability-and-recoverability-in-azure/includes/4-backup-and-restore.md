...
Ermitteln Sie die Sicherungsanforderungen Ihrer App, indem Sie die Daten Ihrer Anwendung anhand der folgenden Anforderungen gruppieren:
...
![Abbildung eines Azure Backup-Agents, der mit einem Wiederherstellungstresor und der Sicherung virtueller Azure-Computer konfiguriert ist Der Backup-Agent und die Sicherung des virtuellen Azure-Computers speichert alle Daten im Wiederherstellungstresor.](../media/azure-backup.png)
