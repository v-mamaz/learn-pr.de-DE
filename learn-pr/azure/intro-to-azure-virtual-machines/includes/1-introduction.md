...
1. Das Geschäft floriert, und das Unternehmen wächst schnell. Es ist wahrscheinlich, dass die Last auf den internen Servern, insbesondere die Datenbanken weiterhin vergrößert werden können, die wir für die Zukunft kaufen oder kommen dann mit einer Skalierung planen, behandeln das Wachstum erfordern.
...
Wir werden sehen Sie sich den getroffenen Entscheidungen vor dem Erstellen eines virtuellen Computers, die Optionen zum Erstellen und Verwalten der VM, und die Erweiterungen und Dienste verwenden, um die Verwaltung des virtuellen Computers.
