...
#### <a name="required-resources-for-iaas-virtual-machines"></a>Erforderliche Ressourcen für virtuelle IaaS-Computer
...
- Erster Punkt: das Netzwerk
- Benennen des virtuellen Computers
- Festlegen des Standorts für den virtuellen Computer
- Bestimmen der Größe des virtuellen Computers
- Grundlegendes zum Preismodell
- Speicher für den virtuellen Computer
- Auswählen eines Betriebssystems

## <a name="start-with-the-network"></a>Erster Punkt: das Netzwerk
...
### <a name="what-if-my-size-needs-change"></a>Was, wenn ich die Größe ändern möchte?

Die VM-Größe kann in Azure geändert werden, wenn sie nicht mehr Ihren Anforderungen entspricht. Sie können den virtuellen Computer upgraden oder downgraden – vorausgesetzt, Ihre aktuelle Hardwarekonfiguration ist mit der neuen Größe kompatibel. Dies ermöglicht eine äußerst agile und flexible VM-Verwaltung.
...
Wenn Sie den virtuellen Computer beenden und die Zuordnung aufheben, können Sie eine beliebige, in Ihrer Region verfügbare Größe auswählen, da der virtuelle Computer in diesem Fall aus dem Cluster entfernt wird, in dem er ausgeführt wurde.
