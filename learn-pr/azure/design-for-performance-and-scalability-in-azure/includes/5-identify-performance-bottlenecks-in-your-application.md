...
Unsere **nicht funktionsbezogenen Anforderungen** helfen Sie uns diesen Punkt zu finden. Diese speziellen Anforderungen teilen uns nicht mit, was unsere App *tun* muss. Vielmehr teilen sie uns mit, welche Qualitätsstufen unsere App erreichen muss. Als Beispiel können wir diese nicht funktionsbezogenen Anforderungen, um uns mitzuteilen definieren:
...
Planung, Entwicklung, Tests und Überwachung werden in einem iterativen Ansatz durchgeführt. Leistung und Qualität unserer Anwendung werden Teil unseres Softwareentwicklungs-Lebenszyklus und sind nicht mehr nur ein Nachsatz beim Bereitstellen in einer Live-Umgebung. Die folgende Abbildung zeigt, in denen Möglichkeiten für die Zusammenarbeit im Lebenszyklus Softwareentwicklung vorhanden.

![Eine Abbildung, zeigt die Schritte eines Software-Lebenszyklus in einer Schleife, um anzuzeigen, wie jede Phase in der nächsten feeds angeordnet.](../media/5-devops-cycle.png)
