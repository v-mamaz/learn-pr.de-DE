...
![Standardwebparts](../media/8-dashboard-default-webparts.png)
...
![Anpassen von Dashboardsteuerelementen](../media/8-customise-dashboard-controls.png)
...
![JSON-Code des Dashboards](../media/8-dashboard-json-code.png)
...
![Dashboard bearbeiten](../media/8-edit-dashboard.png)
...
![Kachelkatalog](../media/8-tile-gallery.png)

Um Kacheln hinzuzufügen, wählen Sie einfach aus der Liste links eine Kachel aus und ziehen sie in den Arbeitsbereich. Sie können jede Kachel verschieben, ihre Größe oder die darin angezeigten Daten ändern.
...
![Bearbeiten der Uhr](../media/8-edit-clock.png)
...
![JSON-Einstellungen](../media/8-json-code.png)
...
![Freigabe und Zugriffssteuerung 1](../media/8-share-dashboards-default.png)

Wenn Sie die Vorlage freigegeben haben, sehen Sie ein zweites Blatt: **Freigabe + Zugriffssteuerung**.

![Freigabe und Zugriffssteuerung 2](../media/8-share-dashboards-access-control.png)
...
![Alle Dashboards durchsuchen](../media/8-browse-dashboards.png)
...
![Freigegebene Dashboards](../media/8-select-shared-dashboard.png)
