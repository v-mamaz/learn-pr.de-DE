...
[![Das Diagramm zeigt die allgemeine Übersicht über Azure-Dienste](../media/2-azure-services.png "Azure-Dienste")](../media/2-azure-services.png#lightbox)

Sehen wir uns einige häufig verwendete Features genauer an: 

- [Compute](#compute-services)
- [Netzwerk](#networking-services)
- [Storage](#storage-services)
- [Mobile](#mobil-services)
- [Datenbanken](#database-services)
- [Web](#web-services)
...
| Azure API Management | Veröffentlichen von APIs für Entwickler, Partner und Mitarbeiter sicher und im erforderlichen Umfang |
